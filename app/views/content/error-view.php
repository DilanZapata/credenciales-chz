 ...
 * Pagina de error.
 *
 * index.php la usa cuando una vista lanza HttpException o cuando la
 * direccion no existe. Nunca muestra rutas ni trazas: solo el mensaje.
 */
$status  = (int) ($errorEstado  ?? 404);
$title   = (string) ($errorTitulo ?? 'Pagina no encontrada');
$message = (string) ($errorMensaje ?? 'La direccion solicitada no existe.');
$pageTitle = $title;
?>
<div class="card">
