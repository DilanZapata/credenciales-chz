...
// Solo se admite volver a una ruta interna: una redireccion abierta serviria
// para llevar al usuario recien autenticado a un sitio ajeno.
$redirect = (string) ($_GET['redirect'] ?? '');
$redirect = preg_match('#^/[A-Za-z0-9/_\-]*$#', $redirect) === 1 && !str_starts_with($redirect, '//')
    ? $redirect : '';
?>
<div class="card">
