<?php
/** Alta y edicion de una credencial. */
...
$id = (int) ($parametrosVista[0] ?? 0);

if ($id > 0) {
    permisoModel::exigir('credentials.update');
    // Se lee sin secretos ni auditoria de consulta: es solo para el formulario.
    $credential = credencialModel::find($id, permisoModel::alcanceCredenciales(), true);
    if ($credential === null) {
        redirigir('/credenciales');
    }
...
$defaultRotation = configuracionModel::entero('credentials.default_rotation_days', 90);
?>
<?php
