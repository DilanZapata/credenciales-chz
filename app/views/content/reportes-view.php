...
$pageTitle = 'Reportes';
$datos = respuestaVista(reporteController::opcionesController());

$categories  = $datos['categories'];
$systems     = $datos['systems'];
$companies   = $datos['companies'];
$locations   = $datos['locations'];
$departments = $datos['departments'];
$usersList   = $datos['users'];
$canExportSecrets = $datos['can_export_secrets'];
$canExportHistory = $datos['can_export_history'];
$canExportAudit   = $datos['can_export_audit'];
?>
<div class="page-head">
