<?php
/** Mi perfil: datos propios, accesos, sesiones y estado del segundo factor. */

use app\controllers\perfilController;

$pageTitle = 'Mi perfil';
$datos = respuestaVista(perfilController::fichaController());

$user           = $datos['user'];
$roles          = $datos['roles'];
$permissions    = $datos['permissions'];
$assignments    = $datos['assignments'];
$sessions       = $datos['sessions'];
$currentSession = $datos['current_session'];
$backupCodes    = $datos['backup_codes'];
?>
<div class="page-head">
