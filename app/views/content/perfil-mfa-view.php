<?php
/** Alta, consulta y baja de la verificacion en dos pasos. */

use app\controllers\perfilController;

$pageTitle = 'Verificacion en dos pasos';

// El alta deja el secreto en un mensaje de un solo uso: si se guardara en
// base de datos antes de confirmarlo, quedaria un TOTP a medio configurar.
$datos = \App\Core\Flash::get('mfa_enrollment');
if (!is_array($datos)) {
    $datos = respuestaVista(perfilController::mfaController());
}

$enabled     = (bool) $datos['enabled'];
$required    = (bool) $datos['required'];
$backupCodes = (int) $datos['backup_codes'];
