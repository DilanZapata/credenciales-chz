<?php
/**
 * Ficha de una credencial.
 *
 * La contrasena NO viaja en este HTML: la caja de secreto la pide al API
 * cuando el usuario pulsa "Mostrar", y ese acceso queda auditado.
 */
...
$accessTrace = $veAuditoria ? credencialModel::secretAccessHistory($id, 15) : [];
?>
<?php
