<?php
/** Importacion masiva de credenciales desde un archivo CSV. */

use app\controllers\importacionController;

$pageTitle = 'Importar credenciales';
$columns = respuestaVista(importacionController::columnasController())['columns'];

// La vista previa la deja en sesion el envio del formulario; al entrar por
// primera vez no hay nada que mostrar.
$preview = \App\Core\Flash::get('import_preview');
$payload = \App\Core\Flash::get('import_payload');
?>
<div class="page-head">
