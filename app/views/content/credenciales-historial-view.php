<?php
/** Historial completo de una credencial: versiones, cambios y accesos. */

use app\controllers\credencialController;

$id   = (int) ($parametrosVista[0] ?? 0);
$data = respuestaVista(credencialController::historialController($id));
$credential = respuestaVista(credencialController::verController($id));

$pageTitle = 'Historial - ' . $credential['name'];
