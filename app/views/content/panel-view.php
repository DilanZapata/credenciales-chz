 ...
 *
 * La vista pide sus datos al controlador; el controlador comprueba el
 * permiso y consulta el modelo. Nunca toca la base de datos directamente.
 */
...
$datos = respuestaVista(tableroController::panelController());

$credentialStats = $datos['credential_stats'];
$userStats       = $datos['user_stats'];
$systemStats     = $datos['system_stats'];
$byCategory      = $datos['by_category'];
$expiring        = $datos['expiring'];
$recentChanges   = $datos['recent_changes'];
$recentSecrets   = $datos['recent_secrets'];
$recentExports   = $datos['recent_exports'];
$recentLogins    = $datos['recent_logins'];
$alerts          = $datos['alerts'];
$securityEvents  = $datos['security_events'];
$topUsers        = $datos['top_users'];
$activeSessions  = $datos['active_sessions'];
$failedLogins24h = $datos['failed_logins_24h'];
$accessSeries    = $datos['access_series'];
?>
<?php
