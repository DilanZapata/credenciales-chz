...
## 7.2 Qué cubre (384 comprobaciones)
...
```
══════════════════════════════════════════════════════════════════════
  TODAS LAS PRUEBAS SUPERADAS  (384/384)
══════════════════════════════════════════════════════════════════════
```
